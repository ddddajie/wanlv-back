...
public class SpotReservationController {
     ...
     * 更新指定景点预约规则。
     */
    @PutMapping("/admin/reservation/rules/{id}")
     ...
     * 更新指定景点预约规则状态。
     */
    @PutMapping("/admin/reservation/rules/{id}/status")
     ...
     * 分页查询景点预约规则。
     */
    @GetMapping("/admin/reservation/rules")
     ...
     * 根据预约规则批量生成预约时段。
     */
    @PostMapping("/admin/reservation/slots/generate")
     ...
     * 分页查询预约时段。
     */
    @GetMapping("/admin/reservation/slots")
     ...
     * 查询已开启预约的景点列表。
     */
    @GetMapping("/reservation/spots/enabled")
     ...
     * 分页查询用户个人预约订单。
     */
    @GetMapping("/reservation/orders/my")
     ...
     * 取消指定预约订单。
     */
    @PostMapping("/reservation/orders/{reservationNo}/cancel")
